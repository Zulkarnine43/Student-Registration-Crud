...
<body>
	...
	<div class="container">
	<center class="h1">City University</center><br><br>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center class="h1">City University</center>
...
<input type="text" class="form-control" name="user_aadhar"  placeholder="Enter NID no. ">
</div>
</div>
...
<div class="form-group">
<label for="inputAddress">Semistar.</label>
<select id="inputState" name="staff_id" class="form-control">
  <option selected>Choose...</option>
